...
class Game < ApplicationRecord
  ...
  # Returns the unique letters in the game.
  # @return [Array<String>] The unique letters in the game.
  def unique_letters
    letters.chars.uniq.sort
  end

  # Returns the letters that are not in the game.
  # This is useful to reduce the number of words that we need to check when compiling a list of words that can be
  # formed from the letters in the game.
  # @return [Array<String>] The letters that are not in the game.
